...
header: Contributing to Mocha
---

Please read these contribution guidelines before submitting an issue, filing a feature request, or creating a pull request.
...
To make a change, you'll need to [create a pull request](https://help.github.com/articles/creating-a-pull-request/).

*Wait!*  Before you dig in, please [search](https://github.com/mochajs/mocha/issues/) for a related issue, or [create a new one](https://github.com/mochajs/mocha/issues/new).  If you wish to contribute a new feature, this is doubly important!  Let's discuss your proposed changes first; we don't want you to waste time implementing a change that is at odds with the project's direction.  That said, we'll happily consider any contribution, no matter how great or small.
...
1.  CI will run against your changes.
  ...
  - Github will indicate if there's a conflict.  If this happens, you will need to [rebase](https://help.github.com/articles/about-git-rebase/) your branch onto the `master` branch of the source repository.
  - "Merge" commits won't be accepted; please rebase instead.
  - You may "squash" your changes if you wish.
1.  Be patient while your PR is reviewed.  This can take awhile!  We may request changes; don't be afraid to question them.
...
- **Can you write?**  Help with the documentation.  See the [`mochajs.github.io` issues](https://github.com/mochajs/mochajs.github.io/issues).
- **Design your thing?**  [This site](https://github.com/mochajs/mochajs.github.io) needs your magic touch.
...
- **All about quality?**  A PR which increases coverage is unlikely to be turned down.
